...
def main(argv: list[str]) -> int:
    ...
    pages = {
        ...
        "make": ("Make a sauce, a rub or a slaw", "Build one by region and taste. Published recipes get named where they exist; everything else says plainly that the proportions are ours.", "build one", None,
                 [("6", "sauce regions"), ("4", "rub levels"), ("4", "slaw dressings")], "vinegar-pepper-sauce"),
