...
def main(argv: list[str]) -> int:
    ...
    pages = {
        ...
        "make": ("Make a sauce or a rub", "Pick a region and how you like it, or a rub from salt alone out to a full modern one. Every proportion says whether it came from a published recipe, a named pitmaster, or this project.", "build one", None,
                 [("6", "sauce regions"), ("4", "rub levels"), ("68", "bottles to measure against")], "vinegar-pepper-sauce"),
